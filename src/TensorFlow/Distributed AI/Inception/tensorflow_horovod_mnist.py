...
def conv_model(feature, target, mode):
    ...
    with tf.variable_scope('conv_layer1'):
        ...
        print(h_pool1.op.name)

#         tf.summary.tensor_summary('conv1', h_pool1)
...
#         tf.summary.tensor_summary('conv2', h_conv2)
...
#     print(hvd.rank())
    ...
    # corrupting them.
    checkpoint_dir = './checkpoints/%d_GPU'%hvd.size() if hvd.rank() == 0 else None
